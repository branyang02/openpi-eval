...
def make_robocasa_example() -> dict:
    ...
    return {
        ...
        "observation/image2": np.random.randint(256, size=(224, 224, 3), dtype=np.uint8),
...
class RobocasaInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        base_image_2 = _parse_image(data.get("observation/image2", data["observation/image"]))
        ...
        if "actions" in data:
            ...
            # For pi0-FAST RoboCasa configs, this is a no-op when action_dim is 12.
