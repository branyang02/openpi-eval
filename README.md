  ...
  <tr>
    ...
    <td>
      <a href="docs/assets/rollouts/liberopro_goal_task_drawer_pi05_rollout.mp4">
        <img src="docs/assets/rollouts/liberopro_goal_task_drawer_pi05_rollout.gif" alt="LIBERO-Pro drawer task rollout preview" width="220">
      </a>
      <br><sub><code>pi05_libero</code>, non-success robustness rollout</sub>
    </td>
    <td>
